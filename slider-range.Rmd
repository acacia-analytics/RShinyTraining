...
shinyApp(
  ...
  ui = fluidPage(
    ...
    fluidRow(column(12, verbatimTextOutput("range")))
...
Creates a slider bar to select two values. Passes the selected values to the server as a vector of two numbers.
